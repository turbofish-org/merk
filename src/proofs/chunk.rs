...
mod tests {
    ...
    fn leaf_chunk_roundtrip() {
        ...
        let chunk = verify_leaf(
            ops,
            [
            34, 133, 104, 181, 253, 249, 189, 168, 15, 209, 70, 164, 224, 192, 18, 36, 1, 74, 79, 9, 158, 188, 98, 47, 53, 32, 109, 14, 151, 13, 49, 74
            ],
        )
        .unwrap();
        let counts = count_node_types(chunk);
        ...
        let chunk = verify_leaf(
            ops,
            [
            164, 29, 123, 213, 6, 25, 247, 238, 127, 53, 5, 70, 255, 87, 87, 204, 188, 169, 181, 4, 185, 180, 74, 52, 244, 134, 75, 47, 105, 129, 209, 112
            ],
        )
        .unwrap();
        let counts = count_node_types(chunk);
