...
mod test {
    ...
    fn child_hash() {
        ...
        assert_eq!(
            ...
            &[
            129, 244, 14, 250, 8, 103, 198, 160, 114, 224, 141, 13, 165, 59, 12, 142, 0, 143, 74, 63, 39, 6, 51, 151, 50, 121, 148, 186, 49, 196, 170, 27
            ]
        );
    ...
    fn hash() {
        ...
        assert_eq!(
            tree.hash(),
            [
            230, 116, 239, 59, 53, 95, 1, 20, 79, 227, 238, 105, 236, 240, 55, 23, 114, 121, 149, 82, 209, 118, 17, 13, 178, 42, 108, 167, 159, 171, 245, 173
            ]
        );
    }
